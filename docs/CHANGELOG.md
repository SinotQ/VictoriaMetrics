...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): add support of Zabbix Connector ingestion format. See [these docs](https://docs.victoriametrics.com/single-server-victoriametrics/#how-to-send-data-from-zabbix-connector) for the details.
